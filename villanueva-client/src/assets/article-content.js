const articles = [
    {
        ...
        content: [
            "Props (short for properties allow you to pass data between components. They are read-only and essnetial for component reusability.",
    ...
    },
    {
        ...
        content: [
            "React Router allows navigation between pages withour a page reload.",
            "Set up routes using BrowserRouter, Routes, and Route components.",
            "Example:\n<Routes>\n <Route path=\"/\ element={<Home />} />\n <Route path=\"/about\" element={<About /> />\n</Routes>",
            "Use Link component for navigation:\n<Link to=\"/about\">About</Links"
        ]
    },
    {
